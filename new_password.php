...
if(isset($_POST['jobid']) && isset($_POST['newpassword']) && isset($_POST['confirmpassword'])){
    ...
    if (empty($jobid)){
        ...
        header("Location:new_password?error=Passwords Do Not Match !!");
        ...
        if ($stmt->rowCount() ===1){
            ...
            $stmt = $conn->prepare("UPDATE sensational_useraccounts SET password =md5(:newpassword) WHERE jobid=:jobid LIMIT 1");
