								...
								<div class="table-responsive mb-0">
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="view_employees?del=<?php echo htmlentities($code);?>" style="font-size:11px;color:#fff;" class="btn btn-warning" onclick="return confirm(' De-Register Employee?')"> Delete </a>
                                            </td>
                                    </tr>
                                    <?php
                                                    }
                                     ...
                                     <tr>
                                                        ...
                                                        <td colspan="3" style="text-align: center;color:red;"> Employee Data Does not Exist !!</td>
                                    ...
                                    <?php
                                     ...
                                     <tr>
                                                        ...
                                                        <td colspan="3" style="text-align: center;color:red;"> Employee not Found !!</td>
