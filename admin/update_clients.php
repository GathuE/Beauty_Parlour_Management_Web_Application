<?php 
 ...
 $cnt=1;
     if($query -> rowCount() > 0)
         {
             header("Location: view_clients?altererror= You cannot Update Client Data!!");
         } 
         else{
                                ...
                                ?>
                                        ...
                                        <div class="row mt-0">
                                                <div class="col">
                                                    ...
                                                    <input type="text"  class="form-control" value="<?php echo htmlentities($result->phone);?>" name="phonenumber" id="phonenumber" readonly>
                                                </div>
